...
// codes basing on C-strings.  CREATORS can be tested only for mechanical
// functioning.  And BSL traits presence should be checked as we declare that
// 'bdlb::CStringHash' is an empty POD.
//
...
//..
// This container stores objects of 'Security' class and allow access them by
// their names.
...
// Then, we create several C-strings with securities names:
//..
    const char *ibm  = "IBM";
    const char *msft = "Microsoft";
    const char *goog = "Google";
//..
// Now, we create container for securities and fill it:
//..
      ...
      case 3: {
        ...
        for (int i = 0; i != NUM_DATA; ++i) {
            ...
            const bsl::size_t HASHCODE  =
                                 static_cast<size_t>(spookyHash.computeHash());
